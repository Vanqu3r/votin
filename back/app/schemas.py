...
class CandidatoSchema(Schema):
    name = fields.String(required=True, validate=validate.Length(min=1))
    apellido = fields.String(required=True, validate=validate.Length(min=1))
    numeroId =  fields.String(required=True, validate=validate.Length(min=1))
    partido = fields.String(required=True)
    telefono = fields.Integer(required=True, validate=validate.Range(min=10))
    validado = fields.Bool(required=True)
